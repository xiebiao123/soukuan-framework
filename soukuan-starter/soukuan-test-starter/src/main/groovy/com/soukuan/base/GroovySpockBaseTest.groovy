...
@WebAppConfiguration
@Rollback
abstract class GroovySpockBaseTest extends Specification {
     ...
     * @return 接口返回原始数据
     */
    protected String apiTest(String uri, def params, Object content) throws Exception {
        ...
        if(content){
            ...
            mock.content(JSONObject.toJSONString(content))
        }
     ...
     * @throws Exception
     */
    protected Object apiTestAssertSuccess(String uri, def params, def content) throws Exception {
        ResponseEntity apiResult = apiTestParseApiResult(uri, params, content)
        assert apiResult.retCode == "200"
     ...
     * @throws Exception
     */
    protected ResponseEntity apiTestParseApiResult(String uri, def params, def content) throws Exception {
